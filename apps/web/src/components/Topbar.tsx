  ...
  return (
    <div className="topbar">
      ...
      <nav className="nav">
        ...
        <NavLink to="/conhecimento" className={({ isActive }) => `nav-link ${isActive ? "active" : ""}`}>
          {IconConhecimento}
          Conhecimento
        </NavLink>
        ...
        <NavLink to="/pagina-publica" className={({ isActive }) => `nav-link ${isActive ? "active" : ""}`}>
          {IconPaginaPublica}
          Página pública
        </NavLink>
      </nav>
