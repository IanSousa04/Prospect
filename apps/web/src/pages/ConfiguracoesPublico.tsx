...
export default function ConfiguracoesPublico() {
  ...
  const url = slug ? `${window.location.origin}/delivery/${slug}` : null;
  ...
  const padraoAtivo = PADROES.find(
    (p) =>
      p.cor_primaria === publico.cor_primaria &&
      p.fonte === publico.fonte &&
      p.layout === publico.layout,
  );
    ...
    <div className="config-pub-page">
      ...
      <div className="page-header">
        ...
        <p className="page-sub">
          Aparência do seu cardápio online e o link para compartilhar.
        </p>
      </div>
      ...
      <div className="config-pub-scroll">
        <section className="secao">
          ...
          <p className="secao-desc">
            Este é o endereço onde seus clientes montam o pedido direto no site.
          </p>
          ...
          {url ? (
            ...
            <p className="secao-desc">
              A página ainda não tem um endereço definido para esta empresa.
            </p>
          )}
        </section>
            ...
            {PADROES.map((padrao) => {
              ...
              return (
                <button
                  ...
                  onClick={() =>
                    salvar({
                      cor_primaria: padrao.cor_primaria,
                      fonte: padrao.fonte,
                      layout: padrao.layout,
                    })
                  }
                >
                  <span
                    ...
                    style={
                      padrao.cor_primaria
                        ? { background: padrao.cor_primaria }
                        : undefined
                    }
                  />
        ...
        <section className="secao">
          ...
          <p className="secao-desc">
            Ajuste cada detalhe do visual da página.{" "}
            {salvando && <span className="salvando-hint">salvando…</span>}
          </p>
            ...
            <div className="ferramenta-top">
              <div>
                ...
                <div className="ferramenta-desc">
                  Botões, preços e elementos de destaque. Sem cor escolhida, usa
                  a cor padrão da plataforma.
                </div>
              </div>
              <div className="cor-controles">
                <input
                  ...
                  onChange={(e) =>
                    salvar({ ...publico, cor_primaria: e.target.value })
                  }
                />
                {publico.cor_primaria && (
                  <button
                    className="btn-pub"
                    onClick={() => salvar({ ...publico, cor_primaria: null })}
                  >
                    Padrão
                  </button>
                )}
          ...
          <div className="ferramenta-row">
            <div className="ferramenta-top">
              <div>
                ...
                <div className="ferramenta-desc">
                  Tipografia usada em toda a página.
                </div>
              </div>
              <select
                ...
                value={publico.fonte}
                onChange={(e) =>
                  salvar({ ...publico, fonte: e.target.value as FontePublico })
                }
              >
          ...
          <div className="ferramenta-row">
            <div className="ferramenta-top">
              <div>
                ...
                <div className="ferramenta-desc">
                  Como o cardápio exibe os itens.
                </div>
              </div>
              <select
                className="campo-select"
                ...
                onChange={(e) =>
                  salvar({
                    ...publico,
                    layout: e.target.value as LayoutPublico,
                  })
                }
              >
